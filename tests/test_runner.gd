...
func _ready() -> void:
	...
	_run_suite("res://tests/application/test_settlement_wiring.gd", "test_settlement_wiring")
	_run_suite("res://tests/application/test_telemetry_wiring.gd", "test_telemetry_wiring")
	...
	_run_suite("res://tests/domain/test_item_inventory_service.gd", "test_item_inventory_service")
	_run_suite("res://tests/domain/test_loadout_service.gd", "test_loadout_service")
	...
	_run_suite("res://tests/domain/test_run_session_service.gd", "test_run_session_service")
	_run_suite("res://tests/domain/test_settlement_service.gd", "test_settlement_service")
	_run_suite("res://tests/domain/test_top_level_state_machine.gd", "test_top_level_state_machine")
	_run_suite("res://tests/domain/test_transaction_service.gd", "test_transaction_service")
	_run_suite("res://tests/domain/test_warehouse_service.gd", "test_warehouse_service")
	_run_suite("res://tests/domain/test_telemetry_service.gd", "test_telemetry_service")
